...
#if !defined(AFX_SCANNER_H__08060DB8_7C71_4634_AC7C_EBF518F0DE9D__INCLUDED_1)
#define AFX_SCANNER_H__08060DB8_7C71_4634_AC7C_EBF518F0DE9D__INCLUDED_1
...
class AFX_EXT_CLASS RTC5: public RTC4
{
protected: 
	UINT status, position;

	bool bAskforWaiter;
	bool bWaiterCanSet;
public:	

	BOOL m_bFirstPulseSync;	
	//Advanced Laser control, >RTC5
	
	BOOL m_bPositionDepend;
	BOOL m_bSpeedDepend;
	
	int m_iAutoDependCtrl;			//1. Analog1 2. Analog2 3. OutputDigital 4.Pulse Width  5.Freq	
	int m_iSpeedDependMode;		//0.Deactive 1. SetSpeed 2. ActualSpeed 5. EncoderSpeed

	double m_AdvLaserMin, m_AdvLaserMax;
	CString strAutoControlScale;
	CString strAutoPosScale;

//	int m_iPosCorrectTalbe;
	UINT m_LaserSignal;
...
//	virtual void ExcuteCMDFunc(ScannerCMD CMDCode, double para1 =0, double para2=0, double para3=0, double para4=0);	
	...
	virtual long RTCOpen(HINSTANCE gLibRTC);	
	...
	virtual void StopAutoLaserControl();
	UINT SetAutoLaserControl(const UINT Ctrl, const UINT Value, const UINT Mode, const UINT MinValue, const UINT MaxValue);
...
protected:	
	...
	typedef void (__stdcall *OD_AOYSZS_FP)(const ULONG_PTR Ptr);
	OD_AOYSZS_FP od_aoyszs;
...
;
#endif // !defined(AFX_GALVOSETTINGS_H__5FD94C31_2552_414E_9C4C_E085E12470EC__INCLUDED_1)
