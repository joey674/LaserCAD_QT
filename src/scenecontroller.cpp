...
void SceneController::setSceneToCenter()
{
    ...
    // QTimer::singleShot(16, []() { SceneController::getIns().setSceneScale(0.8, 0.8); });
    // QTimer::singleShot(18, []() { SceneController::getIns().setSceneScale(0.8, 0.8); });
