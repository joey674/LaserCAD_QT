...
TreeModel::TreeModel(const QString &data, QObject *parent)
    ...
    , rootItem(std::make_unique<TreeNode>(QVariantList{tr("Title"), tr("Summary")}))
{
...
QVariant TreeModel::data(const QModelIndex &index, int role) const
{
    ...
    const auto *item = static_cast<const TreeNode*>(index.internalPointer());
...
int TreeModel::rowCount(const QModelIndex &parent) const
{
    ...
    const TreeNode *parentItem = parent.isValid()
